...
fig.savefig('./plots/standings_by_game.png', dpi=150)
...
fig.savefig('./plots/current_points_standings.png', dpi=150)
...
ax.set_title("MLS Club Standings by Conference\nGame {:2.0f}"
             .format(level_games))
fig.savefig('./plots/level_game_points_standings.png', dpi=150)
